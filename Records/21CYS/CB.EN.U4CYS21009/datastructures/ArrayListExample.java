...
public class ArrayListExample {
    ...
    public static void main(String[] args) {
        // Make a collection
        ArrayList<String> u21 = new ArrayList<String>();

        u21.add("CB.EN.U4CYS22026");
        u21.add("CB.EN.U4CYS22027");
        u21.add("CB.EN.U4CYS22028");
        u21.add("CB.EN.U4CYS22029");
        u21.add("CB.EN.U4CYS22030");
        // Get the iterator
        Iterator<String> it = u21.iterator();
